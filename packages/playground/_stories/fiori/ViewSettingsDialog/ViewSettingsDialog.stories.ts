...
import type ViewSettingsDialog from "@kengine/webcomponents-fiori/dist/ViewSettingsDialog.js";
...
const Template: KENGINEStoryArgs<ViewSettingsDialog, StoryArgsSlots> = (args) => html`<ui5-view-settings-dialog
