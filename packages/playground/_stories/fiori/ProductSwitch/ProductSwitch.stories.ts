...
// @ts-ignore
import type ProductSwitch from "@kengine/webcomponents-fiori/dist/ProductSwitch.js";
...
const Template: KENGINEStoryArgs<ProductSwitch, StoryArgsSlots> = (args) => html`
