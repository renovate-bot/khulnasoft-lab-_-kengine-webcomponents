...
import type NotificationListItem from "@kengine/webcomponents-fiori/dist/NotificationListItem.js";
...
const Template: KENGINEStoryArgs<NotificationListItem, StoryArgsSlots> = (args) => {
