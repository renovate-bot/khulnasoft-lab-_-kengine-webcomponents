...
import type FlexibleColumnLayout from "@kengine/webcomponents-fiori/dist/FlexibleColumnLayout.js";
...
const Template: KENGINEStoryArgs<FlexibleColumnLayout, StoryArgsSlots> = (args) => {
  return html` <style>
      .col {
        height: 100%;
      }
...
Basic.args = {
  startColumn: `
      <div class="col" slot="startColumn">
        ...
        >
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/5/59/KHULNASOFT_2011_logo.svg"
            slot="logo"
          />
          <ui5-shellbar-item
            icon="disconnected"
