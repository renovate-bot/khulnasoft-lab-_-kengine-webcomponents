...
import type Timeline from "@kengine/webcomponents-fiori/dist/Timeline.js";
import TimelineLayout from "@kengine/webcomponents-fiori/dist/types/TimelineLayout.js";
...
const Template: KENGINEStoryArgs<Timeline, StoryArgsSlots> = (args) => html`<ui5-timeline
...
<ui5-timeline-item title-text="Video Converence Call - KENGINE" subtitle-text="31.01.2018 (12:00 - 13:00)" icon="calendar">
