...
// @ts-ignore
import type BarcodeScannerDialog from "@kengine/webcomponents-fiori/dist/BarcodeScannerDialog.js";
...
const Template: KENGINEStoryArgs<BarcodeScannerDialog, StoryArgsSlots> = (
    args
) => html`
