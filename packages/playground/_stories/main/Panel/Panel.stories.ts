...
import type Panel from "@kengine/webcomponents/dist/Panel.js";
import PanelAccessibleRole from "@kengine/webcomponents/dist/types/PanelAccessibleRole.js";
import TitleLevel from "@kengine/webcomponents/dist/types/TitleLevel.js";
...
const Template : KENGINEStoryArgs<Panel, StoryArgsSlots> = (args) => html`
<ui5-panel
	id="panel-${++index}"
