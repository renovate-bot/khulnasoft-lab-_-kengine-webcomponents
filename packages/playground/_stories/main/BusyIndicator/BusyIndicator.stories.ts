...
import BusyIndicatorSize from "@kengine/webcomponents/dist/types/BusyIndicatorSize.js";
...
const Template: KENGINEStoryArgs<BusyIndicator, StoryArgsSlots> = (args) => {
...
<script>
	...
	fetchBtn.addEventListener("click", event => {
		...
		setTimeout(() => {
			["KENGINE", "Web", "Components"].forEach(title => {
