...
import ToastPlacement from "@kengine/webcomponents/dist/types/ToastPlacement.js";

import { DocsPage } from "../../../.storybook/docs";

// @ts-ignore
import type Toast from "@kengine/webcomponents/dist/Toast.js";
...
const Template: KENGINEStoryArgs<Toast, StoryArgsSlots> = (args) => {
	return 	html`
