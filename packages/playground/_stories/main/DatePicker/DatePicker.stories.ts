...
import type DatePicker from "@kengine/webcomponents/dist/DatePicker.js";
...
const Template: KENGINEStoryArgs<DatePicker, StoryArgsSlots> = (args) => html`<ui5-date-picker
