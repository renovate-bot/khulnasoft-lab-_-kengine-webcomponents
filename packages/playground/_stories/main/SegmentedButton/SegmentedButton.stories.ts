...
import type SegmentedButton from "@kengine/webcomponents/dist/SegmentedButton.js";
...
const Template: KENGINEStoryArgs<SegmentedButton, StoryArgsSlots> = (args) => html`<ui5-segmented-button
