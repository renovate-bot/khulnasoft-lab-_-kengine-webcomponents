...
import type SplitButton from "@kengine/webcomponents/dist/SplitButton.js";
...
const Template: KENGINEStoryArgs<SplitButton, StoryArgsSlots> = (args) => html`<ui5-split-button
