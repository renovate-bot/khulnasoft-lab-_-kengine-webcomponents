...
import type ColorPalette from "@kengine/webcomponents/dist/ColorPalette.js";
...
const Template: KENGINEStoryArgs<ColorPalette, StoryArgsSlots> = (args) => html`<ui5-color-palette>
