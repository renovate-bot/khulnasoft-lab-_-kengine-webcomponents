...
import type TimePicker from "@kengine/webcomponents/dist/TimePicker.js";
...
const Template: KENGINEStoryArgs<TimePicker, StoryArgsSlots> = (args) => html`<ui5-time-picker
