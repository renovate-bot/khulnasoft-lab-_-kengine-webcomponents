...
// @ts-ignore
import type ComboBox from "@kengine/webcomponents/dist/ComboBox.js";

import ComboBoxFilter from "@kengine/webcomponents/dist/types/ComboBoxFilter.js";
...
const Template: KENGINEStoryArgs<ComboBox, StoryArgsSlots> = (
		args
) => html`<ui5-combobox
