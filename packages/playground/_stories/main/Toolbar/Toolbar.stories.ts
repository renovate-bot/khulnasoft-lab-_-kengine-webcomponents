...
import type Toolbar from "@kengine/webcomponents/dist/Toolbar.js";
import ToolbarAlign from "@kengine/webcomponents/dist/types/ToolbarAlign.js";
...
const Template: KENGINEStoryArgs<Toolbar, StoryArgsSlots> = (args) => {
...
export const MultipleKENGINESelectComponents : KENGINEStoryArgs<Toolbar, StoryArgsSlots> = (args) => {
	return html`<ui5-toolbar
		align-content="${ifDefined(args.alignContent)}"
	>
		${unsafeHTML(args.default)}
...
MultipleKENGINESelectComponents.storyName = "Multiple Toolbar Select components";

MultipleKENGINESelectComponents.args = {
