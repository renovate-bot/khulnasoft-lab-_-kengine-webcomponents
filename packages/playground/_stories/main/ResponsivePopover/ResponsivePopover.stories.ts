...
import type ResponsivePopover from "@kengine/webcomponents/dist/ResponsivePopover.js";
...
const Template: KENGINEStoryArgs<ResponsivePopover, StoryArgsSlots> = (args) => {
