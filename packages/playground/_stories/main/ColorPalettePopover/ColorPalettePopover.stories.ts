...
import type ColorPalettePopover from "@kengine/webcomponents/dist/ColorPalettePopover.js";
...
const Template: KENGINEStoryArgs<ColorPalettePopover, StoryArgsSlots> = (args) => html`<ui5-color-palette-popover
