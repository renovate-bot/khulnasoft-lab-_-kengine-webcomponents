...
import type Carousel from "@kengine/webcomponents/dist/Carousel.js";
import CarouselArrowsPlacement from "@kengine/webcomponents/dist/types/CarouselArrowsPlacement.js";
...
const Template: KENGINEStoryArgs<Carousel, StoryArgsSlots> = (args) => {
	return html`
<ui5-carousel
...
MultipleItemsPerPage.args = {
	...
	<ui5-timeline>
		...
		<ui5-timeline-item title-text="Video Conference Call - KENGINE" timestamp="1485813600000" icon="calendar">Online meeting</ui5-timeline-item>
	</ui5-timeline>
</ui5-card>
