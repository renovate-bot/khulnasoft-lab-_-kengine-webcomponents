...
import type DateTimePicker from "@kengine/webcomponents/dist/DateTimePicker.js";
...
const Template: KENGINEStoryArgs<DateTimePicker, StoryArgsSlots> = (args) => html`<ui5-datetime-picker
