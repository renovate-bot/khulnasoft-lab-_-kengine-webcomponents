...
import type Card from "@kengine/webcomponents/dist/Card.js";
...
const Template: KENGINEStoryArgs<Card, StoryArgsSlots> = (args) => {
	return html`
<ui5-card
...
WithTimeline.args = {
	...
	<ui5-timeline-item title-text="Video Conference Call - KENGINE" timestamp="1485813600000" icon="calendar">
		Online meeting
	</ui5-timeline-item>
</ui5-timeline>`
};
