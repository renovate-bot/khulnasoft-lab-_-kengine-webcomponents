...
const loadManifest = () => {
    try {
        const customElementsMain = require("@kengine/webcomponents/custom-elements.json");
        const customElementsFiori = require("@kengine/webcomponents-fiori/custom-elements.json");
