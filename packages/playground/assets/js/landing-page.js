...
fetch('https://registry.npmjs.org/@kengine/webcomponents').then(async (response) => {
    ...
    if (ui5wcPackageMetadata?.['dist-tags'].latest) {
        ...
        versionAnchor.setAttribute('href', `https://github.com/khulnasoft-lab/kengine-webcomponents/releases/tag/v${version}`);
    }
});
