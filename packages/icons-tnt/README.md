...
# KENGINE Web Components - KHULNASOFT Fiori Tools (TNT) Icons
...
|--------------------------|------------------------------------------------------------------|
| All icons (~31KB zipped) | `import "@kengine/webcomponents-icons-tnt/dist/AllIcons.js";`        |
| Actor icon               | `import "@kengine/webcomponents-icons-tnt/dist/actor.js";`           |
| Ad hoc actor icon        | `import "@kengine/webcomponents-icons-tnt/dist/ad-hoc-actor.js";`    |
| ...                      | ...                                                              |
| Workflow editor icon     | `import "@kengine/webcomponents-icons-tnt/dist/workflow-editor.js";` |

*Note:* The `@kengine/webcomponents-icons-tnt` package does not provide any web components per se, but rather icon assets,
...
*Note:* For a full list of the icons in the `tnt` collection, click [here](https://sdk.kengine.org/test-resources/sap/m/demokit/iconExplorer/webapp/index.html#/overview/KHULNASOFT-icons-TNT).
...
the framework will detect the current theme and render the corresponding icon - from `TNT Icons v3` (collection name `tnt-v3`) for KHULNASOFT Horizon theme family  (sap_horizon, sap_horizon_dark, etc.), and from `TNT Icons v2` (collection name `tnt-v2`) for all the rest (sap_fiori_3, sap_fiori_3_dark, etc.).
