...
const displayFailedRegistrations = () => {
	...
	let message = `Multiple KENGINE Web Components instances detected.`;
	...
	message = `${message}\n\nTo prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/khulnasoft-lab/kengine-webcomponents/blob/main/docs/2-advanced/03-scoping.md.`;
