...
class KENGINEElementMetadata {
	 ...
	 * <b>Note:</b> Only intended for use by KENGINEElement.js
	 * @public
	 */
	...
	/**
	 * Returns the tag of the KENGINE Element without the scope
	 * @public
	 */
	getPureTag() {
	...
	/**
	 * Returns the tag of the KENGINE Element
	 * @public
	 */
	getTag() {
	...
	/**
	 * Returns an array with the properties of the KENGINE Element (in camelCase)
	 * @public
	 * @returns {string[]}
	 */
	getPropertiesList() {
	...
	/**
	 * Returns an array with the attributes of the KENGINE Element (in kebab-case)
	 * @public
	 * @returns {string[]}
	 */
	getAttributesList() {
	...
	/**
	 * Determines whether this KENGINE Element has a default slot of type Node, therefore can slot text
	 * @returns {boolean}
	 */
	canSlotText() {
	...
	/**
	 * Determines whether this KENGINE Element supports any slots
	 * @public
	 */
	hasSlots() {
	...
	/**
	 * Determines whether this KENGINE Element supports any slots with "individualSlots: true"
	 * @public
	 */
	hasIndividualSlots() {
	...
	/**
	 * Determines whether this KENGINE Element needs to invalidate if children are added/removed/changed
	 * @public
	 */
	slotsAreManaged() {
	...
	/**
	 * Determines whether this KENGINE Element has any translatable texts (needs to be invalidated upon language change)
	 * @returns {boolean}
	 */
	isLanguageAware() {
	...
	/**
	 * Determines whether this KENGINE Element has any theme dependant carachteristics.
	 * @returns {boolean}
	 */
	 isThemeAware() {
...
export default KENGINEElementMetadata;
export type {
	Property,
	PropertyValue,
	Slot,
