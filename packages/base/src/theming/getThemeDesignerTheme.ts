...
const getThemeMetadata = () => {
	...
	let el = document.querySelector(".sapThemeMetaData-Base-baseLib") || document.querySelector(".sapThemeMetaData-KENGINE-sap-ui-core");
	if (el) {
	...
	// Try with sapThemeMetaData-KENGINE-sap-ui-core only if the previous selector was not found
	if (metadata === "none") {
		el.classList.add("sapThemeMetaData-KENGINE-sap-ui-core");
