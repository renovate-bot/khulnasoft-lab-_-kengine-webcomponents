...
const applyOpenKENGINEConfiguration = () => {
	...
	const OpenKENGINEConfig = openKENGINESupport.getConfigurationSettingsObject();
	initialConfig = merge(initialConfig, OpenKENGINEConfig);
};
...
const initConfiguration = () => {
	...
	// 3. If OpenKENGINE is detected, it has the highest priority
	applyOpenKENGINEConfiguration();
