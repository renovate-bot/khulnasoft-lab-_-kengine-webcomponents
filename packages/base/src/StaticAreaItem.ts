...
class StaticAreaItem extends HTMLElement {
	...
	/**
	 * @param {KENGINEElement} ownerElement the KENGINEElement instance that owns this static area item
	 */
	setOwnerElement(ownerElement: KENGINEElement) {
