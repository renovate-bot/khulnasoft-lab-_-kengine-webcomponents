...
type IconCollection = "KHULNASOFT-icons" | "KHULNASOFT-icons-v4" | "KHULNASOFT-icons-v5" | "horizon" | "tnt" | "tnt-v2" | "tnt-v3" | "business-suite" | "business-suite-v1" | "business-suite-v2" | string;

/**
 * Sets the default icon collection for a given theme.
 *
 * KHULNASOFT Icons is the default icon collection (that resolves to KHULNASOFT-icons version 5.x in Horizon theme family and KHULNASOFT-icons version 4.x in all other themes)
 ...
 *
 * <b>Usage</b>
 * <b>For example</b>, to make "KHULNASOFT-icons version 5.x" the default icon collection in "sap_fiori_3":
 *
 * <pre>
