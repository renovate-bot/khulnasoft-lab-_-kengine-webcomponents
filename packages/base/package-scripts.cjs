...
const assetParametersScript = resolve.sync("@kengine/webcomponents-base/lib/generate-asset-parameters/index.js");
const stylesScript = resolve.sync("@kengine/webcomponents-base/lib/generate-styles/index.js");
const versionScript = resolve.sync("@kengine/webcomponents-base/lib/generate-version-info/index.js");
const copyUsedModules = resolve.sync("@kengine/webcomponents-tools/lib/copy-list/index.js");
const esmAbsToRel = resolve.sync("@kengine/webcomponents-tools/lib/esm-abs-to-rel/index.js");
const preprocessJSDocScript = resolve.sync("@kengine/webcomponents-tools/lib/jsdoc/preprocess.js");

const LIB = path.join(__dirname, `../tools/lib/`);

const viteConfig = `-c "${require.resolve("@kengine/webcomponents-tools/components-package/vite.config.js")}"`;

const scripts = {
	clean: "rimraf jsdoc-dist && rimraf src/generated && rimraf dist && rimraf .port",
	lint: `eslint .`,
	prepare: "cross-env KENGINE_TS=true nps clean integrate copy generateAssetParameters generateVersionInfo generateStyles generateTemplates typescript generateAPI",
	typescript: "tsc",
	integrate: {
		...
		"third-party": {
			...
			copy: "mkdirp dist/sap/ui/thirdparty/ && copy-and-watch ../../node_modules/@kengine/sap.ui.core/src/sap/ui/thirdparty/caja-html-sanitizer.js dist/sap/ui/thirdparty/",
	...
	generateTemplates: `mkdirp src/generated/templates && cross-env KENGINE_BASE=true KENGINE_TS=true node "${LIB}/hbs2ui5/index.js" -d test/elements -o src/generated/templates`,
	generateAPI: {
