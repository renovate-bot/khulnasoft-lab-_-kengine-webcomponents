...
const generate = async () => {
	...
	const tsMode = process.env.KENGINE_TS === "true"; // In Typescript mode, we output .ts files and set the required types, otherwise - output pure .js files
	...
	const getOutputFileContent = (properties, defaultLanguageProperties) => {
		...
		return `${tsMode ? `import { I18nText } from "@kengine/webcomponents-base/dist/i18nBundle.js";` : ""}
${texts}
