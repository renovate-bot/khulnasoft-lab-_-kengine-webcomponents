...
// collect each illustration name because each one should have Sample.js file
	...
	const illustrationImportTemplate = illustrationName => {
		...
		return defaultText ? `import { registerIllustration } from "@kengine/webcomponents-base/dist/asset-registries/Illustrations.js";
...
export {
	...
	spotSvg,
			...
			`import { registerIllustration } from "@kengine/webcomponents-base/dist/asset-registries/Illustrations.js";
import dialogSvg from "./${illustrationsPrefix}-Dialog-${illustrationName}.js";
import sceneSvg from "./${illustrationsPrefix}-Scene-${illustrationName}.js";
import spotSvg from "./${illustrationsPrefix}-Spot-${illustrationName}.js";
