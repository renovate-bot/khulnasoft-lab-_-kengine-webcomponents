...
const replaceGlobalCore = resolve.sync("@kengine/webcomponents-tools/lib/replace-global-core/index.js");
...
const scripts = {
	...
	copy: {
		...
		cldr: `node ./lib/copy-and-strip-cldr/index.js "../../node_modules/@kengine/sap.ui.core/src/sap/ui/core/cldr/" dist/generated/assets/cldr/`,
