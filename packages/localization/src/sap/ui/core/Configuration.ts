...
import { getTimezone as getConfigTimezone } from "@kengine/webcomponents-base/dist/config/Timezone.js";
import getDesigntimePropertyAsArray from "@kengine/webcomponents-base/dist/util/getDesigntimePropertyAsArray.js";
// @ts-ignore
...
/**
 * OpenKENGINE Configuration Shim
 */
const Configuration = {
	getLanguage,
	getCalendarType,
