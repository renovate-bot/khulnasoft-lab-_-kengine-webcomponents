import type Locale from "@kengine/webcomponents-base/dist/locale/Locale.js";
import UniversalDate from "./UniversalDate.js";
import type LocaleData from "../LocaleData.js";
import type KENGINEDate from "./KENGINEDate.js";

const calculateWeekNumber = (confFirstDayOfWeek: number | undefined, oDate: Date | KENGINEDate, iYear: number, oLocale: Locale, oLocaleData: LocaleData) => {
	let iWeekNum = 0;
	let iWeekDay = 0;
