...
const assets = require('@kengine/webcomponents-tools/assets-meta.js');

const jsonImportsScript = resolve.sync("@kengine/webcomponents-tools/lib/generate-json-imports/themes.js");
const generateReportScript = resolve.sync("@kengine/webcomponents-theming/lib/generate-css-vars-usage-report/index.js");
...
module.exports = {
	scripts: {
		...
		build: {
			default: `cross-env KENGINE_TS=true nps clean build.src build.themes build.postcss build.jsonImports build.typescript generateReport`,
