...
describe("Testing Range Slider interactions", () => {
	...
	it("Changing the current startValue is reflected", async () => {
		...
		const startHandle = await rangeSlider.shadow$(".kengine-slider-handle--start");
	...
	it("Changing the endValue is reflected", async () => {
		const rangeSlider = await browser.$("#range-slider-tickmarks");
		const endHandle = await rangeSlider.shadow$(".kengine-slider-handle--end");
...
describe("Range Slider elements - tooltip, step, tickmarks, labels", () => {
	it("Range Slider tooltips are displayed showing the current value", async () => {
		...
		const rangeSliderStartTooltip = await rangeSlider.shadow$(".kengine-slider-tooltip--start");
		const rangeSliderStartTooltipValue = await rangeSliderStartTooltip.shadow$(".kengine-slider-tooltip-value");
		const rangeSliderEndTooltip = await rangeSlider.shadow$(".kengine-slider-tooltip--end");
		const rangeSliderEndTooltipValue = await rangeSliderEndTooltip.shadow$(".kengine-slider-tooltip-value");
		const startHandle = await rangeSlider.shadow$(".kengine-slider-handle--start");
		const endHandle = await rangeSlider.shadow$(".kengine-slider-handle--end");
	...
	it("Range Slider have correct number of labels and tickmarks based on the defined step and labelInterval properties", async () => {
		...
		const labelsContainer = await rangeSlider.shadow$(".kengine-slider-labels");
...
describe("Testing events", () => {
	...
	it("Should fire change event after swapping the values", async () => {
		...
		const rangeSlider = await browser.$("#test-slider");
		const firstHandle = await rangeSlider.shadow$(".kengine-slider-handle--start");
	...
	it("Should fire input event with correctly swiped values", async () => {
		...
		const rangeSlider = await browser.$("#test-slider");
		const rangeSliderProgressBar = await rangeSlider.shadow$(".kengine-slider-progress");
		const firstHandle = await rangeSlider.shadow$(".kengine-slider-handle--start");
...
describe("Accessibility", async () => {
	...
	it("Click anywhere in the  Range Slider should focus the closest handle", async () => {
		...
		const rangeSlider = await browser.$("#basic-range-slider");
		const rangeSliderStartHandle = await rangeSlider.shadow$(".kengine-slider-handle--start");
		const rangeSliderEndHandle = await rangeSlider.shadow$(".kengine-slider-handle--end");
	...
	it("Click currently selected range should focus it", async () => {
		...
		const rangeSlider = await browser.$("#basic-range-slider");
		const rangeSliderSelection = await rangeSlider.shadow$(".kengine-slider-progress");
	...
	it("When the second handle has the focus, 'Tab' should move the focus away from the Range Slider", async () => {
		...
		const rangeSliderSelection = await nextRangeSlider.shadow$(".kengine-slider-progress");
	...
	it("Shift+Tab should focus the previous Range Slider and move the focus to its second handle", async () => {
		...
		const previousRangeSliderEndHandle = await previousRangeSlider.shadow$(".kengine-slider-handle--end");
...
describe("Testing resize handling and RTL support", () => {
	...
	it("Testing RTL KBH support", async () => {
		...
		const secondActiveTickmark = await rangeSlider.shadow$$(".kengine-slider-tickmark.kengine-slider-tickmark-in-range")[1];
