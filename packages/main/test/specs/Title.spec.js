...
describe("Rendering", () => {
	...
	it("h{n} tags rendered correctly", async () => {
		const titleH1 = await browser.$("#titleH1").shadow$(".kengine-title-root").getHTML();
		const titleH2 = await browser.$("#titleH2").shadow$(".kengine-title-root").getHTML();
		const titleH3 = await browser.$("#titleH3").shadow$(".kengine-title-root").getHTML();
		const titleH4 = await browser.$("#titleH4").shadow$(".kengine-title-root").getHTML();
		const titleH5 = await browser.$("#titleH5").shadow$(".kengine-title-root").getHTML();
		const titleH6 = await browser.$("#titleH6").shadow$(".kengine-title-root").getHTML();
