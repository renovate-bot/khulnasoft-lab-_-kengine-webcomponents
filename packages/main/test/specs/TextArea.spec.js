	...
	describe("When having max length set", () => {
		...
		describe("Show exceeded text", () => {
			...
			it("Shows counter", async () => {
				...
				const counter = await browser.$("#show-max-length").shadow$(".kengine-textarea-exceeded-text");
			...
			it("Shows exceeded text when maxLength is 0", async () => {
				...
				const counter = await browser.$("#show-max-length-0").shadow$(".kengine-textarea-exceeded-text");
...
describe("Value update", () => {
	...
	it("Value state type should be added to the screen readers default value states announcement", async () => {
		...
		let ariaHiddenText = await tAreaError.shadow$(".kengine-hidden-text").getText();
		...
		ariaHiddenText = await tAreaWarning.shadow$(".kengine-hidden-text").getText();
		...
		ariaHiddenText = await tAreaInformation.shadow$(".kengine-hidden-text").getText();
		valueStateText = await popover.$("div").getText();
		...
		ariaHiddenText = await tAreaCustomError.shadow$(".kengine-hidden-text").getText();
		valueStateText = await popover.$("div").getText();
	...
	it("Should select all exceeded characters on paste", async () => {
		...
		const counter = await browser.$("#ta-exceeded-text").shadow$(".kengine-textarea-exceeded-text");
		const count = parseInt(await counter.getText());
