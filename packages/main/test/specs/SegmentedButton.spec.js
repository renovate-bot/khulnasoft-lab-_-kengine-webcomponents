...
describe("SegmentedButton general interaction", () => {
	...
	it("tests if pressed and tooltip attributes are applied", async () => {
		const segmentedButtonItem =  await browser.$("#segButton1 > kengine-segmented-button-item:first-child");
		const segmentedButtonItemInner = await segmentedButtonItem.shadow$(".kengine-button-root");
	...
	it("tests if pressed attribute is switched to the newly pressed item when selected with enter key", async () => {
		const firstSegmentedButtonItem =  await browser.$("#segButton1 > kengine-segmented-button-item:first-child");
		const secondSegmentedButtonItem =  await browser.$("#segButton1 > kengine-segmented-button-item:nth-child(2)");
	...
	it("tests if pressed attribute is switched to the newly pressed item when selected with space key", async () => {
		const secondSegmentedButtonItem =  await browser.$("#segButton1 > kengine-segmented-button-item:nth-child(2)");
		const lastSegmentedButtonItem =  await browser.$("#segButton1 > kengine-segmented-button-item:last-child");
	...
	it("tests if pressed attribute is applied only to last child when all items are pressed", async () => {
		const segmentedButtonItem1 =  await browser.$("#segButton2 > kengine-segmented-button-item:first-child");
		const segmentedButtonItem2 =  await browser.$("#segButton2 > kengine-segmented-button-item:nth-child(2)");
		const segmentedButtonItem3 =  await browser.$("#segButton2 > kengine-segmented-button-item:nth-child(3)");
		const segmentedButtonItem4 =  await browser.$("#segButton2 > kengine-segmented-button-item:last-child");
	...
	it("tests if a pressed item could be deselected", async () => {
		const firstSegmentedButtonItem =  await browser.$("#segButtonMulti > kengine-segmented-button-item:first-child");
	...
	it("tests if multiple items could be pressed", async () => {
		const firstSegmentedButtonItem =  await browser.$("#segButtonMulti > kengine-segmented-button-item:first-child");
		const secondSegmentedButtonItem =  await browser.$("#segButtonMulti > kengine-segmented-button-item:nth-child(1)");
