...
describe("Interactions", () => {
	...
	it("switch active clock", async () => {
		...
		const clocks = await clocksComponent.shadow$$("kengine-time-picker-clock");
		const buttons = await clocksComponent.shadow$$("kengine-toggle-spin-button");
	...
	it("switch AM/PM", async () => {
		...
		const amPmSegmentedButon = await clocksAmPmComponent.shadow$("kengine-segmented-button");
		const amButtonItem =  await amPmSegmentedButon.$("kengine-segmented-button-item:first-child");
		const pmButtonItem =  await amPmSegmentedButon.$("kengine-segmented-button-item:last-child");
		const buttons = await clocksAmPmComponent.shadow$$("kengine-toggle-spin-button");
...
describe("Accessibility", () => {
	it("accessibility-related attributes", async () => {
		const clocksComponent = await browser.$("#myClocks");
		const clocksWrapper = clocksComponent.shadow$(".kengine-time-picker-tsc-clocks");
		const buttons = await clocksComponent.shadow$$("kengine-toggle-spin-button");
		const clocks = await clocksComponent.shadow$$("kengine-time-picker-clock");
...
describe("Events", () => {
	it("'change' event", async () => {
		...
		const buttons = await amPmClocksComponent.shadow$$("kengine-toggle-spin-button");
