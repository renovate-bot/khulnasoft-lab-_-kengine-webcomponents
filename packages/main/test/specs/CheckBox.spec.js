...
describe("CheckBox general interaction", () => {
	...
	it("tests truncating and wrapping", async () => {
		...
		const truncatingCb = await browser.$("#truncatingCb").shadow$(".kengine-checkbox-root");
	...
	it("tests accessible-name and accessible-name-ref", async () => {
		const defaultCb = await browser.$("#cb2").shadow$(".kengine-checkbox-root");
		const accCheckBox = await browser.$("#accCb").shadow$(".kengine-checkbox-root");
		const accNameRefCheckBox = await browser.$("#accCb1").shadow$(".kengine-checkbox-root");
	...
	it("tests kengine-icon", async () => {
		const checkboxChecked = await browser.$("#checkboxChecked").shadow$(".kengine-checkbox-icon");
