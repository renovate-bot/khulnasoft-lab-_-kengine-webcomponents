...
describe("Rendering", () => {
	...
	it("DOM structure", async () => {
		const radioButtonRoot = await browser.$("#testRbtn1").shadow$(".kengine-radio-root");
		...
		const disabledRadioButtonRoot = await browser.$("#testRbtn").shadow$(".kengine-radio-root");
		...
		const readOnlyRadioButtonRoot = await browser.$("#groupRbReadOnly").shadow$(".kengine-radio-root");
...
describe("RadioButton general interaction", () => {
	...
	it("tests change event", async () => {
		const radioButton = await browser.$("#rb1").shadow$(".kengine-radio-root");
	...
	it("tests change event upon ENTER", async () => {
		const radioButton1 = await browser.$("#rb1").shadow$(".kengine-radio-root");
		const radioButton2 = await browser.$("#rb2").shadow$(".kengine-radio-root");
		const field = await browser.$("#field");
	...
	it("tests change event upon SPACE", async () => {
		const radioButton1 = await browser.$("#rb2").shadow$(".kengine-radio-root");
		const radioButton2 = await browser.$("#rb3").shadow$(".kengine-radio-root");
		const field = await browser.$("#field");
	...
	it("tests change event not fired, when disabled", async () => {
		const radioButton = await browser.$("#rb4").shadow$(".kengine-radio-root");
		const field = await browser.$("#field");
	...
	it("tests tabindex within group with selected item", async () => {
		const checkedRadio = await browser.$("#testRbtn11").shadow$(".kengine-radio-root");
		const disabledRadio = await browser.$("#testRbtn12").shadow$(".kengine-radio-root");
		const radio = await browser.$("#testRbtn13").shadow$(".kengine-radio-root");
	...
	it("tests tabindex within group with no checked item", async () => {
		const radio1 = await browser.$("#testRbtn1").shadow$(".kengine-radio-root");
		const radio2 = await browser.$("#testRbtn2").shadow$(".kengine-radio-root");
	...
	it("tests radio buttons selection within group by clicking", async () => {
		...
		const radioButtonPreviouslySelectedRoot = await browser.$("#groupRb6").shadow$(".kengine-radio-root");

		const radioButtonToBeSelected = await browser.$("#groupRb4");
		const radioButtonToBeSelectedRoot = await browser.$("#groupRb4").shadow$(".kengine-radio-root");
	...
	it("tests change event from radio buttons within group", async () => {
		const radioButtonToBeSelectedShadow = await browser.$("#groupRb7").shadow$(".kengine-radio-root");
	...
	it("correctly assigns tabindex when the whole group has been removed from DOM and added back to DOM", async () => {
		...
		let radioButtons = await rbContainer.$$("kengine-radio-button");
		let radioButtonsShadowRoots = await Promise.all(radioButtons.map(rb => rb.shadow$(`.kengine-radio-root`)));
		...
		radioButtons = await rbContainer.$$(`kengine-radio-button`);
		radioButtonsShadowRoots = await Promise.all(radioButtons.map(rb => rb.shadow$(`.kengine-radio-root`)));
	...
	it("tests form interaction", async () => {
		...
		await rb.shadow$(".kengine-radio-root").click();
