...
describe("ColorPalette interactions", () => {
	...
	it("Test if focusing first element works on initial open", async () => {
		...
		const colorPalettePopover = await browser.$("[kengine-color-palette-popover]");
		const responsivePopover = await colorPalettePopover.shadow$("[kengine-responsive-popover]")
		const colorPalette = await responsivePopover.$("[kengine-color-palette]");
		const defaultButton = await colorPalette.shadow$(".kengine-cp-default-color-button");
	...
	it("Test if default color functionality works", async () => {
		...
		await colorPaletteButton.click();
		const colorPalettePopover = await browser.$("[kengine-color-palette-popover]");
		const colorPalette = await colorPalettePopover.shadow$("[kengine-responsive-popover]").$("[kengine-color-palette]");
		const defaultButton = await colorPalette.shadow$(".kengine-cp-default-color-button");
	...
	it("Test if keyboard navigation on elements works", async () => {
		...
		const colorPalettePopover = await browser.$("[kengine-color-palette-popover]");
		const colorPalette = await colorPalettePopover.shadow$("[kengine-responsive-popover]").$("[kengine-color-palette]");
		const colorPaletteEntries = await colorPalette.shadow$$("[kengine-color-palette-item]");
		const defaultButton = await colorPalette.shadow$(".kengine-cp-default-color-button");
	...
	it("Test if keyboard navigation on elements works", async () => {
		...
		const colorPalettePopover = await browser.$("[kengine-color-palette-popover]");
		const colorPalette = await colorPalettePopover.shadow$("[kengine-responsive-popover]").$("[kengine-color-palette]");
		const moreColorsButton = await colorPalette.shadow$(".kengine-cp-more-colors");
		const defaultButton = await colorPalette.shadow$(".kengine-cp-default-color-button");
	...
	it("Tests navigation with recent colors", async () => {
		...
		const defaultButton = await colorPalette.shadow$(".kengine-cp-default-color-button");
		const moreColorsButton = await colorPalette.shadow$(".kengine-cp-more-colors");
		const firstRecentColorsElement = await colorPalette.shadow$(".kengine-cp-recent-colors-container [kengine-color-palette-item]");
