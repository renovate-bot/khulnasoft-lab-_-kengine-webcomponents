...
describe("Icon collection", () => {
	...
	it("Tests the icon collection in built-in themes", async () => {
		...
		// assert: "KHULNASOFT-icons-v4" is used in legacy "sap_fiori_3_dark" theme
		assert.strictEqual(result.iconCollection, "KHULNASOFT-icons-v4",
			"The 'KHULNASOFT-icons-v4' collection is correctly used in 'sap_fiori_3_dark' theme");
		...
		// assert:  "KHULNASOFT-icons-v5" is used in latest "sap_horizon" theme
		assert.strictEqual(result2.iconCollection, "KHULNASOFT-icons-v5",
			"The 'KHULNASOFT-icons-v5' collection is correctly used in 'sap_horizon' theme");
...
describe("Icon collection in Custom Theme", () => {
	...
	it("Tests the icon collection in a custom theme", async () => {
		...
		assert.strictEqual(result.iconCollection, "KHULNASOFT-icons-v5",
			"The 'KHULNASOFT-icons-v5' collection is correctly used in 'redfish' - extending 'sap_horizon'");
