...
describe("MessageStrip general interaction", () => {
	...
	it("tests close event", async () => {
		...
		const closeButton = await browser.$("#messageStrip").shadow$(".kengine-message-strip-close-button");
...
describe("ARIA Support", () => {
	...
	it("Test close button title text", async () => {
		...
		const closeButton = await browser.$("#messageStrip").shadow$(".kengine-message-strip-close-button").shadow$("button");
	...
	it("Test hidden text element content", async () => {
		...
		let invisibleText = await messageStrip.shadow$(".kengine-hidden-text");
		let resourceBundleText = null;
