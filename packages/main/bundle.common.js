import "@kengine/webcomponents-base/dist/features/F6Navigation.js";
import { addCustomCSS, attachThemeLoaded, detachThemeLoaded } from "@kengine/webcomponents-base/dist/Theming.js";
...
// CLDR
import getLocaleData from "@kengine/webcomponents-localization/dist/locale/getLocaleData.js";

// Uncomment to test the registration of custom properties and JSON bundles - use the TextArea test page
// import { registerI18nLoader } from "@kengine/webcomponents-base/dist/asset-registries/i18n.js";
// import parse from "@kengine/webcomponents-base/dist/PropertiesFileFormat.js";

// const bg = "https://sdk.kengine.org/resources/sap/ui/core/messagebundle_bg.properties";
// registerI18nLoader("@kengine/webcomponents", "bg", async (localeId) => {
// 	const props = await (await fetch(bg)).text();
// 	return parse(props);
// });
// registerI18nLoader("@kengine/webcomponents", "fr", async (localeId) => {
...
import { sanitizeHTML, URLListValidator } from "@kengine/webcomponents-base/dist/util/HTMLSanitizer.js";
window.sanitizeHTML = sanitizeHTML;
window.URLListValidator = URLListValidator;

import { getAnimationMode, setAnimationMode } from "@kengine/webcomponents-base/dist/config/AnimationMode.js";
import { getTheme, setTheme, isLegacyThemeFamily } from "@kengine/webcomponents-base/dist/config/Theme.js";
import { getThemeRoot, setThemeRoot } from "@kengine/webcomponents-base/dist/config/ThemeRoot.js";
import { getTimezone, setTimezone } from "@kengine/webcomponents-base/dist/config/Timezone";
import { getLanguage, setLanguage } from "@kengine/webcomponents-base/dist/config/Language.js";
import getEffectiveIconCollection from "@kengine/webcomponents-base/dist/asset-registries/util/getIconCollectionByTheme.js";
import { setNoConflict } from "@kengine/webcomponents-base/dist/config/NoConflict.js";
...
import { _getRegisteredNames as getIconNames, getIconAccessibleName } from  "@kengine/webcomponents-base/dist/asset-registries/Icons.js";
import applyDirection from "@kengine/webcomponents-base/dist/locale/applyDirection.js";
import { attachDirectionChange } from "@kengine/webcomponents-base/dist/locale/directionChange.js";
...
import { ignoreCustomElements, shouldIgnoreCustomElement } from "@kengine/webcomponents-base/dist/IgnoreCustomElements.js";
ignoreCustomElements("app-");
ignoreCustomElements("my-");

// KHULNASOFT Icons
import accept from "@kengine/webcomponents-icons/dist/accept.js";
import acceptv4 from "@kengine/webcomponents-icons/dist/v4/accept.js";
import acceptv5 from "@kengine/webcomponents-icons/dist/v5/accept.js";
// KHULNASOFT TNT Icons
import actor from "@kengine/webcomponents-icons-tnt/dist/actor.js";
import actorv2 from "@kengine/webcomponents-icons-tnt/dist/v2/actor.js";
import actorv3 from "@kengine/webcomponents-icons-tnt/dist/v3/actor.js";
// KHULNASOFT BS Icons
import icon_3d from "@kengine/webcomponents-icons-business-suite/dist/3d.js";
import icon_3dv1 from "@kengine/webcomponents-icons-business-suite/dist/v1/3d.js";
import icon_3dv2 from "@kengine/webcomponents-icons-business-suite/dist/v2/3d.js";
import { setUseLinks, setPackageCSSRoot } from "@kengine/webcomponents-base/dist/CSP.js";
...
// setPackageCSSRoot("@kengine/webcomponents-fiori", "./resources/css/fiori/");
...
// The KHULNASOFT Icons V4 icon collection is set by default in sap_fiori_3,
// but it's configurable:
// import { setDefaultIconCollection } from  "@kengine/webcomponents-base/dist/config/Icons.js";
// setDefaultIconCollection("sap_fiori_3", "KHULNASOFT-icons-v5");
// or for custom theme
// setDefaultIconCollection("my_custom_theme", "KHULNASOFT-icons-v5");
// or for custom icon collection
// setDefaultIconCollection("sap_fiori_3", "my-custom-icons");

import {registerIconLoader } from "@kengine/webcomponents-base/dist/asset-registries/Icons.js";
