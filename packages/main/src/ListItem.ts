...
import { isSpace, isEnter, isDelete } from "@kengine/webcomponents-base/dist/Keys.js";
...
abstract class ListItem extends ListItemBase {
	...
	*/
	 ...
	 * design guidelines, please use the <code>kengine-button</code> component.
	...
	/*
	 * Called when selection components in Single (kengine-radio-button)
	 * and Multi (kengine-checkbox) selection modes are used.
	 */
	...
	static async onDefine() {
		ListItem.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
}
