...
import { getEffectiveAriaLabelText, getAssociatedLabelForTexts } from "@kengine/webcomponents-base/dist/util/AriaLabelHelper.js";
...
import { isEscape } from "@kengine/webcomponents-base/dist/Keys.js";
 ...
 *
 * The <code>kengine-textarea</code> component is used to enter multiple lines of text.
 * <br><br>
 * When empty, it can hold a placeholder similar to a <code>kengine-input</code>.
 * You can define the rows of the <code>kengine-textarea</code> and also determine specific behavior when handling long texts.
 *
 ...
 * <br>
 * The <code>kengine-textarea</code> exposes the following CSS Shadow Parts:
 * <ul>
 ...
 *
 * <code>import "@kengine/webcomponents/dist/TextArea";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.TextArea
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-textarea
 * @public
 */
@customElement({
	tag: "kengine-textarea",
	languageAware: true,
...
class TextArea extends KENGINEElement implements IFormElement {
	/**
	...
	static async onDefine() {
		TextArea.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	_onfocusout(e: FocusEvent) {
		...
		const focusedOutToValueStateMessage = eTarget?.shadowRoot?.querySelector(".kengine-valuestatemessage-root");
	...
	async openPopover() {
		...
		this.valueStatePopover && await this.valueStatePopover.showAt(this.shadowRoot!.querySelector(".kengine-textarea-root .kengine-textarea-wrapper")!);
	}
