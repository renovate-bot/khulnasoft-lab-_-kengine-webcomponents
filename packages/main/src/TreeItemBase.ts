...
class TreeItemBase extends ListItem {
	...
	* </ul>
	* <br>
	* <b>Note:</b> This property takes effect only when the <code>kengine-tree</code> is in <code>MultiSelect</code> mode.
	* @type {boolean}
	...
	*/
	 ...
	 * <br />
	 * <br />
	 * <b>Note:</b> Use <code>kengine-tree-item</code> or <code>kengine-tree-item-custom</code>
	 *
	...
	get classes(): ClassMap {
		...
		allClasses.main["kengine-li-root-tree"] = true;
		return allClasses;
	}
	...
	get styles() {
		return {
			preContent: {
				"padding-inline-start": `calc(var(${getScopedVarName("--_kengine-tree-indent-step")}) * ${this.effectiveLevel})`,
			},
		};
	}
