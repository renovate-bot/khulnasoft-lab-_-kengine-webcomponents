...
import type { ChangeInfo } from "@kengine/webcomponents-base/dist/KENGINEElement.js";
...
import transformDateToSecondaryType from "@kengine/webcomponents-localization/dist/dates/transformDateToSecondaryType.js";
import convertMonthNumbersToMonthNames from "@kengine/webcomponents-localization/dist/dates/convertMonthNumbersToMonthNames.js";
import CalendarDate from "@kengine/webcomponents-localization/dist/dates/CalendarDate.js";
import { renderFinished } from "@kengine/webcomponents-base/dist/Render.js";
import {
	isF4,
	isF4Shift,
} from "@kengine/webcomponents-base/dist/Keys.js";
import getCachedLocaleDataInstance from "@kengine/webcomponents-localization/dist/getCachedLocaleDataInstance.js";
import getLocale from "@kengine/webcomponents-base/dist/locale/getLocale.js";
import DateFormat from "@kengine/webcomponents-localization/dist/DateFormat.js";
...
import "@kengine/webcomponents-localization/dist/features/calendar/Gregorian.js";
 ...
 *
 * The <code>kengine-calendar</code> component allows users to select one or more dates.
 * <br><br>
 * Currently selected dates are represented with instances of <code>kengine-date</code> as
 * children of the <code>kengine-calendar</code>. The value property of each <code>kengine-date</code> must be a
 * date string, correctly formatted according to the <code>kengine-calendar</code>'s <code>formatPattern</code> property.
 * Whenever the user changes the date selection, <code>kengine-calendar</code> will automatically create/remove instances
 * of <code>kengine-date</code> in itself, unless you prevent this behavior by calling <code>preventDefault()</code> for the
 ...
 * The <code>kengine-calendar</code> provides advanced keyboard handling.
 ...
 * <br><br>
 *
 * <code>import "@kengine/webcomponents-localization/dist/features/calendar/Buddhist.js";</code>
 * <br>
 * <code>import "@kengine/webcomponents-localization/dist/features/calendar/Islamic.js";</code>
 * <br>
 * <code>import "@kengine/webcomponents-localization/dist/features/calendar/Japanese.js";</code>
 * <br>
 * <code>import "@kengine/webcomponents-localization/dist/features/calendar/Persian.js";</code>
 * <br><br>
 *
 ...
 * create instances of <code>kengine-date</code> for the newly selected dates. In that case you should do this manually.
 *
...
class Calendar extends CalendarPart {
	 ...
	 * for this calendar as instances of <code>kengine-date</code>.
	 *
	...
	get _currentPickerDOM() {
		...
		return this.shadowRoot!.querySelector(`[kengine-${this._currentPicker}picker]`)! as unknown as ICalendarPicker;
	}
	...
	/**
	 * Creates instances of <code>kengine-date</code> inside this <code>kengine-calendar</code> with values, equal to the provided UTC timestamps
	 * @protected
	 * @deprecated
