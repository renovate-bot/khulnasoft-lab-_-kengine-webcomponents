...
import { getTheme } from "@kengine/webcomponents-base/dist/config/Theme.js";
import {
	isBackSpace,
	isSpace,
	isDelete,
...
import "@kengine/webcomponents-icons/dist/sys-cancel.js";
...
class Token extends KENGINEElement implements ITabbable {
	/**
	 ...
	 * This flag is used in the kengine-multi-combobox
	 *
	 * @type {boolean}
	 * @defaultvalue false
	 * @private
	 ...
	 * Accepts <code>kengine-icon</code>.
	 *
	...
	get textDom() {
		return this.getDomRef()?.querySelector(".kengine-token--text");
	}
	...
	static async onDefine() {
		Token.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
}
