 ...
 * The <code>kengine-toolbar-spacer</code> is an element, used for taking needed space for toolbar items to take 100% width.
 ...
 * @tagname kengine-toolbar-spacer
 * @abstract
 * @since 1.17.0
