...
import { TemplateFunction } from "@kengine/webcomponents-base/dist/renderer/executeTemplate.js";
 ...
 * @class
 *
 * The <code>kengine-tb-item</code> represents an abstract class for items,
 ...
 * @since 1.17.0
 */
class ToolbarItem extends KENGINEElement implements IToolbarItem {
	/**
