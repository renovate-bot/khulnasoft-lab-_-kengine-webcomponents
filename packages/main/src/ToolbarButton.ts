 ...
 * The <code>kengine-toolbar-button</code> represents an abstract action,
 * used in the <code>kengine-toolbar</code>.
 *
 * <h3>ES6 Module Import</h3>
 * <code>import "@kengine/webcomponents/dist/ToolbarButton";</code>
 *
 * @constructor
 * @abstract
 ...
 * @tagname kengine-toolbar-button
 * @public
 * @implements sap.ui.webc.main.IToolbarItem
 * @since 1.17.0
 */
@customElement({
	tag: "kengine-toolbar-button",
	dependencies: [Button],
})
...
class ToolbarButton extends ToolbarItem {
	 ...
	 * <br><br>
	 * <b>Note:</b>
	 * KHULNASOFT-icons font provides numerous buil-in icons. To find all the available icons, see the
	 * <kengine-link target="_blank" href="https://kengine.hana.ondemand.com/test-resources/sap/m/demokit/iconExplorer/webapp/index.html" class="api-table-content-cell-link">Icon Explorer</kengine-link>.
	 *
	 * @type {string}
	 * @defaultvalue ""
