...
import { isEnter } from "@kengine/webcomponents-base/dist/Keys.js";
...
import {
	...
	HEXToRGB,
	RGBToHSL,
} from "@kengine/webcomponents-base/dist/util/ColorConversion.js";
import type {
	ColorHSL,
	ColorRGB,
} from "@kengine/webcomponents-base/dist/util/ColorConversion.js";
 ...
 * The <code>kengine-color-picker</code> allows users to choose any color and provides different input options for selecting colors.
 *
 * <h3>Usage</h3>
 *
 * <h4>When to use:</h4
 ...
 *
 * <code>import "@kengine/webcomponents/dist/ColorPicker.js";</code>
 *
 * @constructor
 ...
 * @tagname kengine-color-picker
 * @public
 */

@customElement({
	tag: "kengine-color-picker",
	renderer: litRender,
 ...
 */
@event("change")
class ColorPicker extends KENGINEElement {
	/**
	...
	static async onDefine() {
		ColorPicker.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	onBeforeRendering() {
		...
		this._setHex();
		this._setValues();
		this.style.setProperty(getScopedVarName("--kengine_Color_Picker_Progress_Container_Color"), tempColor);
	}
