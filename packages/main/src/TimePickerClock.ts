...
const CLOCK_NUMBER_CLASS = "kengine-tp-clock-number";
const CLOCK_NUMBER_HOVER_CLASS = "kengine-tp-clock-number-hover";
const CLOCK_NUMBER_SELECTED_CLASS = "kengine-tp-clock-selected";
const CLOCK_MIDDOT_CLASS = "kengine-tp-clock-mid-dot";
 ...
 *
 * <code>kengine-time-picker-clock</code> allows selecting of hours,minutes or seconds (depending on property set).
 ...
 *
 * <code>kengine-time-picker-clock</code> is used as part of <code>kengine-time-selection-clocks</code> component, which
 * is used in <code>kengine-time-picker</code> component respectively.
 *
 * <h3>Usage</h3>
 *
 * <code>kengine-time-picker-clock</code> can display hours, minutes or seconds
 *
 * <h3>ES6 Module Import</h3>
 *
 * <code>import "@kengine/webcomponents/dist/TimePickerClock.js";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.TimePickerClock
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-time-picker-clock
 * @since 1.15.0
 * @private
 */
@customElement({
	tag: "kengine-time-picker-clock",
	renderer: litRender,
...
class TimePickerClock extends KENGINEElement {
	/**
	...
	get classes(): ClassMap {
		return <ClassMap>{
			clock: {
				"kengine-tp-clock": true,
				"kengine-tp-clock-inner": this.showInnerCircle,
				"kengine-tp-clock-active": this.active,
			},
		};
	}
	...
	_getClockCoverContainerDomRef() {
		...
		return domRef && domRef.querySelector(".kengine-tp-clock-cover");
	}
