...
class CalendarHeader extends KENGINEElement {
	/**
	...
	*/
	...
	static async onDefine() {
		CalendarHeader.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	get classes() {
		return {
			prevButton: {
				"kengine-calheader-arrowbtn": true,
				"kengine-calheader-arrowbtn-disabled": this.isPrevButtonDisabled,
			},
			nextButton: {
				"kengine-calheader-arrowbtn": true,
				"kengine-calheader-arrowbtn-disabled": this.isNextButtonDisabled,
			},
		};
	}
