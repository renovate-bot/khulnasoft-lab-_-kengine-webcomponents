 ...
 * The <code>kengine-toolbar-separator</code> is an element, used for visual separation between two elements.
 ...
 * @tagname kengine-toolbar-separator
 * @since 1.17.0
 * @abstract
