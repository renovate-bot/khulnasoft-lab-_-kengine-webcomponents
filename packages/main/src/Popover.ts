...
import { isIOS } from "@kengine/webcomponents-base/dist/Device.js";
import DOMReference from "@kengine/webcomponents-base/dist/types/DOMReference.js";
import { getClosedPopupParent } from "@kengine/webcomponents-base/dist/util/PopupUtils.js";
 ...
 *
 * The <code>kengine-popover</code> component displays additional information for an object
 ...
 * </ul>
 *
 * <b>Note:</b> The <code>kengine-popover</code> is closed when the user clicks
 ...
 * <br>
 * The <code>kengine-popover</code> exposes the following CSS Shadow Parts:
 * <ul>
...
class Popover extends Popup {
	...
	isOpenerClicked(e: MouseEvent) {
		...
		const kengineElementTarget = target as KENGINEElement;

		if (kengineElementTarget.getFocusDomRef && kengineElementTarget.getFocusDomRef() === this._opener) {
			return true;
		}
	...
	get arrowDOM() {
		return this.shadowRoot!.querySelector(".kengine-popover-arrow")!;
	}
	...
	get classes() {
		...
		allClasses.root["kengine-popover-root"] = true;
