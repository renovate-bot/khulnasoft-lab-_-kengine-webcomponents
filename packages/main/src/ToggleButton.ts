...
import { isSpaceShift } from "@kengine/webcomponents-base/dist/Keys.js";
import { isSafari } from "@kengine/webcomponents-base/dist/Device.js";
 ...
 *
 * The <code>kengine-toggle-button</code> component is an enhanced <code>kengine-button</code>
 * that can be toggled between pressed and normal states.
 * Users can use the <code>kengine-toggle-button</code> as a switch to turn a setting on or off.
 * It can also be used to represent an independent choice similar to a check box.
 * <br><br>
 * Clicking or tapping on a <code>kengine-toggle-button</code> changes its state to <code>pressed</code>. The button returns to
 * its initial state when the user clicks or taps on it again.
 * By applying additional custom CSS-styling classes, apps can give a different style to any <code>kengine-toggle-button</code>.
 *
 * <h3>ES6 Module Import</h3>
 *
 * <code>import "@kengine/webcomponents/dist/ToggleButton";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.ToggleButton
 * @extends sap.ui.webc.main.Button
 * @tagname kengine-toggle-button
 * @public
 */
@customElement({
	tag: "kengine-toggle-button",
