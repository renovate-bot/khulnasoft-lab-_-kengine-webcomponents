 ...
 * For the <code>kengine-daterange-picker</code>
 * <h3>ES6 Module Import</h3>
 *
 * <code>import "@kengine/webcomponents/dist/DateRangePicker.js";</code>
 *
 * <h3>Keyboard Handling</h3>
 * The <code>kengine-daterange-picker</code> provides advanced keyboard handling.
 * <br>
 *
 * When the <code>kengine-daterange-picker</code> input field is focused the user can
 ...
 * @tagname kengine-daterange-picker
 * @since 1.0.0-rc.8
 * @public
 */
@customElement({
	tag: "kengine-daterange-picker",
