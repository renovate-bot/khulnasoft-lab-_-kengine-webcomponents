 ...
 *
 * The <code>kengine-table-column</code> component allows to define column specific properties that are applied
 * when rendering the <code>kengine-table</code> component.
 *
 ...
 * <br>
 * The <code>kengine-table-column</code> exposes the following CSS Shadow Parts:
 * <ul>
 ...
 * @tagname kengine-table-column
 * @implements sap.ui.webc.main.ITableColumn
 * @public
 */
@customElement({
	tag: "kengine-table-column",
	styles: tableColumnStyles,
	renderer: litRender,
	template: TableColumnTemplate,
})
class TableColumn extends KENGINEElement {
	/**
	 * Defines the minimum table width required to display this column. By default it is always displayed.
	 * <br><br>
	 * The responsive behavior of the <code>kengine-table</code> is determined by this property. As an example, by setting
