 ...
 *
 * The <code>kengine-label</code> is a component used to represent a label for elements like input, textarea, select. <br><br>
 * The <code>for</code> property of the <code>kengine-label</code> must be the same as the id attribute of the related input element.<br><br>
 * Screen readers read out the label, when the user focuses the labelled control.
 * <br><br>
 * The <code>kengine-label</code> appearance can be influenced by properties,
...
class Label extends KENGINEElement {
	/**
	 * Defines the labeled input by providing its ID.
	 * <br><br>
	 * <b>Note:</b> Can be used with both <code>kengine-input</code> and native input.
	 *
	 * @type {string}
	...
	static async onDefine() {
		Label.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
