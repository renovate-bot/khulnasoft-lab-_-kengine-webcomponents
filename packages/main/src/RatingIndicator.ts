...
import "@kengine/webcomponents-icons/dist/favorite.js";
import "@kengine/webcomponents-icons/dist/unfavorite.js";
 ...
 * <br>
 * Example: <code>&lt;kengine-rating-indicator style="font-size: 3rem;">&lt;/kengine-rating-indicator></code>
 *
 * <h3>Keyboard Handling</h3>
 * When the <code>kengine-rating-indicator</code> is focused, the user can change the rating
 ...
 *
 * <code>import "@kengine/webcomponents/dist/RatingIndicator.js";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.RatingIndicator
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-rating-indicator
 * @public
 * @since 1.0.0-rc.8
 */

@customElement({
	tag: "kengine-rating-indicator",
	languageAware: true,
	renderer: litRender,
...
class RatingIndicator extends KENGINEElement {
	/**
	...
	static async onDefine() {
		RatingIndicator.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	_onclick(e: MouseEvent) {
		const target = e.target as KENGINEElement;

		if (!(target instanceof HTMLElement) || this.disabled || this.readonly) {
			return;
		}

		const targetValue = target.getAttribute("data-kengine-value");
