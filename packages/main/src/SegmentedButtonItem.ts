 ...
 *
 * Users can use the <code>kengine-segmented-button-item</code> as part of a <code>kengine-segmented-button</code>.
 * <br><br>
 * Clicking or tapping on a <code>kengine-segmented-button-item</code> changes its state to <code>pressed</code>.
 * The item returns to its initial state when the user clicks or taps on it again.
 * By applying additional custom CSS-styling classes, apps can give a different style to any
 * <code>kengine-segmented-button-item</code>.
 *
 * <h3>ES6 Module Import</h3>
 *
 * <code>import "@kengine/webcomponents/dist/SegmentedButtonItem";</code>
 *
 * @constructor
 ...
 * @abstract
 * @tagname kengine-segmented-button-item
 * @implements sap.ui.webc.main.ISegmentedButtonItem
 * @public
 */
@customElement({
	tag: "kengine-segmented-button-item",
