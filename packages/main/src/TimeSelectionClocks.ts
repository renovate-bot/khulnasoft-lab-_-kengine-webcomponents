 ...
 *
 * <code>kengine-time-selection-clocks</code> is component that contains all the <code>kengine-time-picker-clock</code> components
 * necessary for the <code>kengine-time-picker</code> as well as all necessary <code>kengine-toggle-spin-button</code> components
 * used for switching between different clocks.
 * <code>kengine-time-picker-clock</code> components and <code>kengine-toggle-spin-button</code> depend on the time format set to
 * <code>kengine-time-picker</code> component.
 *
 ...
 * @abstract
 * @tagname kengine-time-selection-clocks
 * @since 1.15.0
 * @private
 */
@customElement({
	tag: "kengine-time-selection-clocks",
	renderer: litRender,
