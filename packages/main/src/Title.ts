 ...
 *
 * The <code>kengine-title</code> component is used to display titles inside a page.
 * It is a simple, large-sized text with explicit header/title semantics.
 *
 * <h3>ES6 Module Import</h3>
 *
 * <code>import "@kengine/webcomponents/dist/Title";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.Title
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-title
 * @public
 */
@customElement({
	tag: "kengine-title",
...
class Title extends KENGINEElement {
	/**
