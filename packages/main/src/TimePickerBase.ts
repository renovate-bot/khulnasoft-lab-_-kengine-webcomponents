...
import "@kengine/webcomponents-localization/dist/features/calendar/Gregorian.js"; // default calendar for bundling
...
import "@kengine/webcomponents-icons/dist/time-entry-request.js";
...
/**
 * Fired when the value of the <code>kengine-time-picker</code> is changed at each key stroke.
 *
...
class TimePickerBase extends KENGINEElement {
	/**
	...
	/**
	 * Defines the value state of the <code>kengine-time-picker</code>.
	 * <br><br>
	...
	/**
	 * Determines whether the <code>kengine-time-picker</code> is displayed as disabled.
	 *
	 * @type {boolean}
	...
	/**
	 * Determines whether the <code>kengine-time-picker</code> is displayed as readonly.
	 *
	 * @type {boolean}
	...
	/**
	 * Defines the value state message that will be displayed as pop up under the <code>kengine-time-picker</code>.
	 * <br><br>
	 *
	 * <b>Note:</b> If not specified, a default text (in the respective language) will be displayed.
	 * <br>
	 * <b>Note:</b> The <code>valueStateMessage</code> would be displayed,
	 * when the <code>kengine-time-picker</code> is in <code>Information</code>, <code>Warning</code> or <code>Error</code> value state.
	 * @type {HTMLElement}
	...
	async onResponsivePopoverAfterOpen() {
		...
		const responsivePopover = await this._getPopover();
		responsivePopover.querySelector<TimeSelectionClocks>("[kengine-time-selection-clocks]")!._focusFirstButton();
	}
	...
	async onInputsPopoverAfterOpen() {
		const popover = await this._getInputsPopover();
		popover.querySelector<TimeSelectionInputs>("[kengine-time-selection-inputs]")!._addNumericAttributes();
	}
	...
	async _handleInputClick(evt: MouseEvent) {
		...
		if (this._isPhone && target && !target.hasAttribute("kengine-icon")) {
