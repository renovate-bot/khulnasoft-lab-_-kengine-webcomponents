 ...
 *
 * <code>kengine-time-selection-inputs</code> displays a popover with <code>kengine-input</code> components of type="number" and an
 * optional a AM/PM <code>kengine-segmented-button</code> according to the display format given to the <code>kengine-time-picker</code>.
 ...
 * The popup appears only on mobile devices when there is a tap on the <code>kengine-time-picker</code> input.
 *
 ...
 * @abstract
 * @tagname kengine-time-selection-inputs
 * @since 1.18.0
 * @private
 */
@customElement({
	tag: "kengine-time-selection-inputs",
	renderer: litRender,
