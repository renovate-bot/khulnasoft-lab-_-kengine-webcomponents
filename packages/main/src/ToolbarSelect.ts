...
import CSSSize from "@kengine/webcomponents-base/dist/types/CSSSize.js";
 ...
 * The <code>kengine-toolbar-select</code> component is used to create a toolbar drop-down list.
 * The items inside the <code>kengine-toolbar-select</code> define the available options by using the <code>kengine-toolbar-select-option</code> component.
 *
 * <h3>ES6 Module Import</h3>
 * <code>import "@kengine/webcomponents/dist/ToolbarSelect";</code>
 * <br>
 * <code>import "@kengine/webcomponents/dist/ToolbarSelectOption";</code> (comes with <code>kengine-toolbar-select</code>)
 * @constructor
 * @abstract
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.ToolbarSelect
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-toolbar-select
...
class ToolbarSelect extends ToolbarItem {
	 ...
	 *
	 * <br><br>
	 * <b>Note:</b> Use the <code>kengine-toolbar-select-option</code> component to define the desired options.
	...
	_onEventHandler(e: Event): void {
		if (e.type === "change") {
			...
			const selectedOptionIndex = Number(selectedOption?.getAttribute("data-kengine-external-action-item-index"));
