 ...
 *
 * The <code>kengine-badge</code> is a small non-interactive component which contains text information and color chosen from a list of predefined color schemes.
...
class Badge extends KENGINEElement {
	/**
	...
	static async onDefine() {
		Badge.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
