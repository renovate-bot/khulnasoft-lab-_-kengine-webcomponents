...
import "@kengine/webcomponents-icons/dist/add.js";
 ...
 *
 * The <code>kengine-step-input</code> consists of an input field and buttons with icons to increase/decrease the value
 ...
 */
@event("change")
class StepInput extends KENGINEElement implements IFormElement {
	/**
	...
	static async onDefine() {
		StepInput.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	get inputOuter() {
		return this.shadowRoot!.querySelector(".kengine-step-input-input")!;
	}
