 ...
 * The <code>kengine-tree</code> component provides a tree structure for displaying data in a hierarchy.
 *
 * <h3>Usage</h3>
 *
 * <h4>When to use:</h4>
 ...
 *
 * The <code>kengine-tree</code> provides advanced keyboard handling.
 ...
 * <code>import "@kengine/webcomponents/dist/Tree.js";</code>
 * <br>
...
class Tree extends KENGINEElement {
	/**
	 * Defines the mode of the component. Since the tree uses a <code>kengine-list</code> to display its structure,
	 ...
	 * <br><br>
	 * <b>Note:</b> Use <code>kengine-tree-item</code> for the intended design.
	 *
	...
	onAfterRendering() {
		...
		this.shadowRoot!.querySelector<TreeList>("[kengine-tree-list]")!.onBeforeRendering();
	}
