...
import modifyDateBy from "@kengine/webcomponents-localization/dist/dates/modifyDateBy.js";
import getRoundedTimestamp from "@kengine/webcomponents-localization/dist/dates/getRoundedTimestamp.js";
import getTodayUTCTimestamp from "@kengine/webcomponents-localization/dist/dates/getTodayUTCTimestamp.js";
...
import { isPhone, isDesktop } from "@kengine/webcomponents-base/dist/Device.js";
import CalendarPickersMode from "./types/CalendarPickersMode.js";
import type FormSupportT from "./features/InputElementsFormSupport.js";
import type { IFormElement } from "./features/InputElementsFormSupport.js";
import "@kengine/webcomponents-icons/dist/appointment-2.js";
 ...
 *
 * The <code>kengine-date-picker</code> component provides an input field with assigned calendar which opens on user action.
 * The <code>kengine-date-picker</code> allows users to select a localized date using touch,
 ...
 * For more information, see <kengine-link target="_blank" href="http://unicode.org/reports/tr35/#Date_Field_Symbol_Table">UTS #35: Unicode Locale Data Markup Language</kengine-link>.
 * <br><br>
 * For example, if the <code>format-pattern</code> is "yyyy-MM-dd",
 * a valid value string is "2015-07-30" and the same is displayed in the input.
 *
 * <h3>Keyboard Handling</h3>
 * The <code>kengine-date-picker</code> provides advanced keyboard handling.
 * If the <code>kengine-date-picker</code> is focused,
 ...
 * <br>
 *
 * If the <code>kengine-date-picker</code> input field is focused and its corresponding picker dialog is not opened,
 ...
 *
 * <code>import "@kengine/webcomponents/dist/DatePicker";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.DatePicker
 * @extends sap.ui.webc.main.DateComponentBase
 * @tagname kengine-date-picker
 * @public
 */

@customElement({
	tag: "kengine-date-picker",
	languageAware: true,
...
class DatePicker extends DateComponentBase implements IFormElement {
	...
	_getInput(): Input {
		return this.shadowRoot!.querySelector<Input>("[kengine-input]")!;
	}

	/**
	 * The kengine-input "submit" event handler - fire change event when the user presses enter
	 * @protected
	 */
	_onInputSubmit() {}

	/**
	 * The kengine-input "change" event handler - fire change event when the user focuses out of the input
	 * @protected
	 */
	...
	/**
	 * The kengine-input "input" event handler - fire input even when the user types
	 * @protected
	 */
