...
import { Timeout } from "@kengine/webcomponents-base/dist/types.js";
 ...
 *
 * <code>kengine-menu</code> component represents a hierarchical menu structure.
 *
 * <h3>Usage</h3>
 *
 * <code>kengine-menu</code> contains <code>kengine-menu-item</code> components.
 * An arbitrary hierarchy structure can be represented by recursively nesting menu items.
 *
 * <h3>Keyboard Handling</h3>
 *
 * The <code>kengine-menu</code> provides advanced keyboard handling.
 ...
 * @allowPreventDefault
 * @since 1.10.0
 * @param { HTMLElement } item The <code>kengine-menu-item</code> that triggers opening of the sub-menu or undefined when fired upon root menu opening. <b>Note:</b> available since 1.14.0.
 */
@event("before-open", {
	detail: {
		item: {
 ...
 */
@event("after-close")
class Menu extends KENGINEElement {
	/**
	...
	/**
	 * Defines if a loading indicator would be displayed inside the corresponding kengine-menu popover.
	 *
	 ...
	 * <br><br>
	 * <b>Note:</b> Use <code>kengine-menu-item</code> for the intended design.
	 *
	...
	static async onDefine() {
		Menu.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	async _createPopover() {
		...
		this._popover = staticAreaItemDomRef!.querySelector<ResponsivePopover>("[kengine-responsive-popover]")!;
	...
	_createSubMenu(item: MenuItem, openerId: string) {
		...
		subMenu.appendChild(fragment);
		this.staticAreaItem!.shadowRoot!.querySelector(".kengine-menu-submenus")!.appendChild(subMenu);
