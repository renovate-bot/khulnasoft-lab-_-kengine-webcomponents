 ...
 * <br><br>
 * The <code>kengine-checkbox</code> component consists of a box and a label that describes its purpose.
 * If it's checked, an indicator is displayed inside the box.
 * To check/uncheck the <code>kengine-checkbox</code>, the user has to click or tap the square
 * box or its label.
 * <br><br>
 * The <code>kengine-checkbox</code> component only has 2 states - checked and unchecked.
 * Clicking or tapping toggles the <code>kengine-checkbox</code> between checked and unchecked state.
 *
 * <h3>Usage</h3>
 *
 ...
 * The touchable area for toggling the <code>kengine-checkbox</code> ends where the text ends.
 * <br><br>
 * You can disable the <code>kengine-checkbox</code> by setting the <code>disabled</code> property to
 * <code>true</code>,
 * or use the <code>kengine-checkbox</code> in read-only mode by setting the <code>readonly</code>
 ...
 * <br>
 * The <code>kengine-checkbox</code> exposes the following CSS Shadow Parts:
 * <ul>
 * <li>root - Used to style the outermost wrapper of the <code>kengine-checkbox</code></li>
 * </ul>
 *
 * <br><br>
 * <h3>Keyboard Handling</h3>
 *
 * The user can use the following keyboard shortcuts to toggle the checked state of the <code>kengine-checkbox</code>.
 * <ul>
 ...
 *
 * <code>import "@kengine/webcomponents/dist/CheckBox";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.CheckBox
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-checkbox
 * @public
 */
@customElement({
	tag: "kengine-checkbox",
	languageAware: true,
	renderer: litRender,
...
class CheckBox extends KENGINEElement implements IFormElement {
	/**
	...
	*/
	...
	get classes() {
		return {
			main: {
				"kengine-checkbox--hoverable": !this.disabled && !this.readonly && isDesktop(),
			},
		};
	}
	...
	static async onDefine() {
		CheckBox.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
}
