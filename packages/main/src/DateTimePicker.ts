...
import "@kengine/webcomponents-icons/dist/date-time.js";
 ...
 * For more information, see <kengine-link target="_blank" href="https://unicode.org/reports/tr35/tr35-dates.html#Date_Field_Symbol_Table">UTS #35: Unicode Locale Data Markup Language</kengine-link>.
 * <br><br>
 ...
 *
 * <code>import "@kengine/webcomponents/dist/DateTimePicker.js";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.DateTimePicker
 * @extends sap.ui.webc.main.DatePicker
 * @tagname kengine-datetime-picker
 * @since 1.0.0-rc.7
 * @public
 */
@customElement({
	tag: "kengine-datetime-picker",
...
class DateTimePicker extends DatePicker {
	...
	get classes() {
		return {
			picker: {
				"kengine-dt-picker-content--phone": this.phone,
			},
			dateTimeView: {
				"kengine-dt-cal--hidden": this.phone && this.showTimeView,
				"kengine-dt-time--hidden": this.phone && this.showDateView,
			},
			footer: {
				"kengine-dt-picker-footer-time-hidden": (this.phone && this.showTimeView) || (this.phone && this.showDateView),
			},
		};
	}
