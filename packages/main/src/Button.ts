...
import type { PassiveEventListenerObject } from "@kengine/webcomponents-base/dist/types.js";
...
import { markEvent } from "@kengine/webcomponents-base/dist/MarkedEvents.js";
import { getIconAccessibleName } from "@kengine/webcomponents-base/dist/asset-registries/Icons.js";
 ...
 *
 * The <code>kengine-button</code> component represents a simple push button.
 * It enables users to trigger actions by clicking or tapping the <code>kengine-button</code>, or by pressing
 * certain keyboard keys, such as Enter.
 *
 *
 * <h3>Usage</h3>
 *
 * For the <code>kengine-button</code> UI, you can define text, icon, or both. You can also specify
 * whether the text or the icon is displayed first.
 * <br><br>
 * You can choose from a set of predefined types that offer different
 * styling to correspond to the triggered action.
 * <br><br>
 * You can set the <code>kengine-button</code> as enabled or disabled. An enabled
 * <code>kengine-button</code> can be pressed by clicking or tapping it. The button changes
 * its style to provide visual feedback to the user that it is pressed or hovered over with
 * the mouse cursor. A disabled <code>kengine-button</code> appears inactive and cannot be pressed.
 *
 ...
 * <br>
 * The <code>kengine-button</code> exposes the following CSS Shadow Parts:
 * <ul>
 ...
 */
@event("click")
class Button extends KENGINEElement implements IFormElement {
	/**
	 ...
	 * Example:
	 *
	 * See all the available icons within the <kengine-link target="_blank" href="https://sdk.kengine.org/test-resources/sap/m/demokit/iconExplorer/webapp/index.html">Icon Explorer</kengine-link>.
	 *
	 * @type {string}
	...
	async onBeforeRendering() {
		...
		if (this.type !== ButtonType.Button && !formSupport) {
			console.warn(`In order for the "type" property to have effect, you should also: import "@kengine/webcomponents/dist/features/InputElementsFormSupport.js";`); // eslint-disable-line
		}
		if (this.submits && !formSupport) {
			console.warn(`In order for the "submits" property to have effect, you should also: import "@kengine/webcomponents/dist/features/InputElementsFormSupport.js";`); // eslint-disable-line
		}
	...
	static async onDefine() {
		Button.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
}
