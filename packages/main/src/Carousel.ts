...
import ScrollEnablement from "@kengine/webcomponents-base/dist/delegate/ScrollEnablement.js";
import type { ScrollEnablementEventListenerParam } from "@kengine/webcomponents-base/dist/delegate/ScrollEnablement.js";
...
import "@kengine/webcomponents-icons/dist/slim-arrow-left.js";
 ...
 * When the <code>kengine-carousel</code> is focused the user can navigate between the items
 ...
 * <br>
 * The <code>kengine-carousel</code> exposes the following CSS Shadow Parts:
 * <ul>
 ...
 *
 * <code>import "@kengine/webcomponents/dist/Carousel.js";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.Carousel
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-carousel
 * @since 1.0.0-rc.6
 * @public
 */
@customElement({
	tag: "kengine-carousel",
	languageAware: true,
	fastNavigation: true,
	renderer: litRender,
	styles: CarouselCss,
...
class Carousel extends KENGINEElement {
	/**
	...
	get items() {
		return this.content.map((item, idx) => {
			...
			return {
				...
				classes: visible ? "" : "kengine-carousel-item--hidden",
			};
		});
	}
	...
	get classes() {
		return {
			viewport: {
				"kengine-carousel-viewport": true,
				"kengine-carousel-viewport--single": this.pagesCount === 1,
			},
			content: {
				"kengine-carousel-content": true,
				"kengine-carousel-content-no-animation": this.suppressAnimation,
				"kengine-carousel-content-has-navigation": this.renderNavigation,
				"kengine-carousel-content-has-navigation-and-buttons": this.renderNavigation && this.arrowsPlacement === CarouselArrowsPlacement.Navigation && !this.hideNavigationArrows,
			},
			navigation: {
				"kengine-carousel-navigation-wrapper": true,
				"kengine-carousel-navigation-with-buttons": this.renderNavigation && this.arrowsPlacement === CarouselArrowsPlacement.Navigation && !this.hideNavigationArrows,
				[`kengine-carousel-navigation-wrapper-bg-${this.pageIndicatorBackgroundDesign.toLowerCase()}`]: true,
				[`kengine-carousel-navigation-wrapper-border-${this.pageIndicatorBorderDesign.toLowerCase()}`]: true,
			},
			navPrevButton: {
				"kengine-carousel-navigation-button--hidden": !this.hasPrev,
			},
			navNextButton: {
				"kengine-carousel-navigation-button--hidden": !this.hasNext,
			},
		};
	}
	...
	static async onDefine() {
		Carousel.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
}
