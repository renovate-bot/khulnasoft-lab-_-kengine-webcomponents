 ...
 *
 * <code>kengine-time-picker-internals</code> is helper component that contains shared methods used in <code>kengine-time-selection-clocks</code>
 * and <kengine-time-selection-inputs> components and should not be used separately.
 *
 * @constructor
 ...
 * @abstract
 * @tagname kengine-time-picker-internals
 * @since 1.15.0
 * @private
 */
@customElement({
	tag: "kengine-time-picker-internals",
})
...
class TimePickerInternals extends KENGINEElement {
	/**
