 ...
 * The <code>kengine-slider</code> component adjusts to the size of its parent container by recalculating and
 ...
 * <br>
 * The <code>kengine-slider</code> exposes the following CSS Shadow Parts:
 * <ul>
 * <li>progress-container - Used to style the progress container(the horizontal bar which visually represents the range between the minimum and maximum value) of the <code>kengine-slider</code>.</li>
 * <li>progress-bar - Used to style the progress bar, which shows the progress of the <code>kengine-slider</code>.</li>
 * <li>handle - Used to style the handle of the <code>kengine-slider</code>.</li>
 * </ul>
 *
...
class Slider extends SliderBase {
	...
	get _sliderHandle() {
		return this.shadowRoot!.querySelector(".kengine-slider-handle")!;
	}
	...
	static async onDefine() {
		Slider.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
