 ...
 * The <code>kengine-link</code> is a hyperlink component that is used to navigate to other
 ...
 * <h3>Usage</h3>
 *
 * You can set the <code>kengine-link</code> to be enabled or disabled.
 * <br><br>
...
class Link extends KENGINEElement implements ITabbable {
	/**
	...
	static async onDefine() {
		Link.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
