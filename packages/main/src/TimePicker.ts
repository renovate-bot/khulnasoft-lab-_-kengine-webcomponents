 ...
 * The <code>kengine-time-picker</code> component provides an input field with assigned clocks which are opened on user action.
 * The <code>kengine-time-picker</code> allows users to select a localized time using touch, mouse, or keyboard input.
 ...
 * For the <code>kengine-time-picker</code>
 *
 * <h3>Formatting</h3>
 *
 ...
 *
 * <code>import "@kengine/webcomponents/dist/TimePicker.js";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.TimePicker
 * @extends sap.ui.webc.main.TimePickerBase
 * @tagname kengine-time-picker
 * @public
 * @since 1.0.0-rc.6
 */
@customElement("kengine-time-picker")
