...
enum DesignClassesMapping {
	Information = "kengine-message-strip-root--info",
	Positive = "kengine-message-strip-root--positive",
	Negative = "kengine-message-strip-root--negative",
	Warning = "kengine-message-strip-root--warning",
}
 ...
 *
 * The <code>kengine-message-strip</code> component enables the embedding of app-related messages.
 ...
 * <h3>Usage</h3>
 *
 * For the <code>kengine-message-strip</code> component, you can define whether it displays
 ...
 *
 * <code>import "@kengine/webcomponents/dist/MessageStrip";</code>
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.MessageStrip
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-message-strip
 * @public
 * @since 0.9.0
 */
@customElement({
	tag: "kengine-message-strip",
	languageAware: true,
	renderer: litRender,
...
class MessageStrip extends KENGINEElement {
	/**
	...
	static async onDefine() {
		MessageStrip.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	get classes(): ClassMap {
		return {
			root: {
				"kengine-message-strip-root": true,
				"kengine-message-strip-root-hide-icon": this.hideIcon,
				"kengine-message-strip-root-hide-close-button": this.hideCloseButton,
