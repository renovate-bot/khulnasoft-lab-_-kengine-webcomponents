...
import getEffectiveScrollbarStyle from "@kengine/webcomponents-base/dist/util/getEffectiveScrollbarStyle.js";
 ...
 *
 * The <code>kengine-list</code> component allows displaying a list of items, advanced keyboard
 * handling support for navigating between items, and predefined modes to improve the development efficiency.
 * <br><br>
 * The <code>kengine-list</code> is a container for the available list items:
 * <ul>
 * <li><code>kengine-li</code></li>
 * <li><code>kengine-li-custom</code></li>
 * <li><code>kengine-li-groupheader</code></li>
 * </ul>
 * <br><br>
 ...
 * <br><br>
 * Additionally, the <code>kengine-list</code> provides header, footer, and customization for the list item separators.
 *
 * <br><br>
 * <h3>Keyboard Handling</h3>
 *
 * <h4>Basic Navigation</h4>
 * The <code>kengine-list</code> provides advanced keyboard handling.
 ...
 *
 * <code>import "@kengine/webcomponents/dist/List.js";</code>
 * <br>
 * <code>import "@kengine/webcomponents/dist/StandardListItem.js";</code> (for <code>kengine-li</code>)
 * <br>
 * <code>import "@kengine/webcomponents/dist/CustomListItem.js";</code> (for <code>kengine-li-custom</code>)
 * <br>
 * <code>import "@kengine/webcomponents/dist/GroupHeaderListItem.js";</code> (for <code>kengine-li-groupheader</code>)
 *
 * @constructor
 * @author KHULNASOFT SE
 * @alias sap.ui.webc.main.List
 * @extends sap.ui.webc.base.KENGINEElement
 * @tagname kengine-list
...
class List extends KENGINEElement {
	/**
	 ...
	 * <br><br>
	 * <b>Note:</b> Use <code>kengine-li</code>, <code>kengine-li-custom</code>, and <code>kengine-li-groupheader</code> for the intended design.
	 *
	...
	static async onDefine() {
		List.i18nBundle = await getI18nBundle("@kengine/webcomponents");
	}
	...
	get listEndDOM() {
		return this.shadowRoot!.querySelector(".kengine-list-end-marker");
	}
	...
	get classes(): ClassMap {
		return {
			root: {
				"kengine-list-root": true,
				"kengine-content-native-scrollbars": getEffectiveScrollbarStyle(),
			},
		};
	}
	...
	*/
	...
	_revertSelection(previouslySelectedItems: Array<ListItemBase>) {
		this.getItems().forEach((item: ListItemBase) => {
			...
			const multiSelectCheckBox = item.shadowRoot!.querySelector<CheckBox>(".kengine-li-multisel-cb");
			const singleSelectRadioButton = item.shadowRoot!.querySelector<RadioButton>(".kengine-li-singlesel-radiobtn");
	...
	*/
	...
	onItemClose(e: CustomEvent<ListItemCloseEventDetail>) {
		const target = e.target as KENGINEElement | null;
		const shouldFireItemClose = target?.hasAttribute("kengine-li-notification") || target?.hasAttribute("kengine-li-notification-group");
