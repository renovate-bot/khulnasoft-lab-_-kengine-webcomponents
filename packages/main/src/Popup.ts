...
import { isChrome, isSafari } from "@kengine/webcomponents-base/dist/Device.js";
import { getFirstFocusableElement, getLastFocusableElement } from "@kengine/webcomponents-base/dist/util/FocusableElements.js";
...
import { hasStyle, createStyle } from "@kengine/webcomponents-base/dist/ManagedStyles.js";
import { isEnter, isTabPrevious } from "@kengine/webcomponents-base/dist/Keys.js";
import { getNextZIndex, getFocusedElement, isFocusedElementWithinNode } from "@kengine/webcomponents-base/dist/util/PopupUtils.js";
...
import MediaRange from "@kengine/webcomponents-base/dist/MediaRange.js";
...
const createBlockingStyle = (): void => {
	if (!hasStyle("data-kengine-popup-scroll-blocker")) {
		createStyle(globalStyles, "data-kengine-popup-scroll-blocker");
	}
};
 ...
 *
 * If you need to create your own popup-like custom KENGINE Web Components, it is highly recommended that you extend
 ...
 */
@event("scroll")
abstract class Popup extends KENGINEElement {
	/**
	...
	*/
	...
	static blockPageScrolling(popup: Popup) {
		...
		document.documentElement.classList.add("kengine-popup-scroll-blocker");
	}
	...
	static unblockPageScrolling(popup: Popup) {
		...
		document.documentElement.classList.remove("kengine-popup-scroll-blocker");
	}
	...
	get _root(): HTMLElement {
		return this.shadowRoot!.querySelector(".kengine-popup-root")!;
	}
	...
	get contentDOM(): HTMLElement {
		return this.shadowRoot!.querySelector(".kengine-popup-content")!;
	}
