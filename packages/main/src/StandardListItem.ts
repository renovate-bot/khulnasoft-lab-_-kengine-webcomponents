...
/**
 * @class
 * The <code>kengine-li</code> represents the simplest type of item for a <code>kengine-list</code>.
 *
 * This is a list item,
 ...
 * <br>
 * The <code>kengine-li</code> exposes the following CSS Shadow Parts:
 * <ul>
...
class StandardListItem extends ListItem implements IAccessibleListItem {
	 ...
	 * design guidelines, please use the <code>kengine-avatar</code> with it`s default size - S.
	 * <b>Note:</b> If bigger <code>kengine-avatar</code> needs to be used, then the size of the
	 * <code>kengine-li</code> should be customized in order to fit.
	 * @type {HTMLElement[]}
