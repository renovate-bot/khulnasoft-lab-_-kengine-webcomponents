 ...
 * while the social timeline offers a high level of interaction and collaboration, and is integrated within KHULNASOFT Jam.
 *
 * @constructor
...
class Timeline extends KENGINEElement {
	/**
	...
	static async onDefine() {
		Timeline.i18nBundle = await getI18nBundle("@kengine/webcomponents-fiori");
	}
