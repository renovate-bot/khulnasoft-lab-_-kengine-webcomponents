 ...
 *
 * The <code>ui5-product-switch</code> is an KHULNASOFT Fiori specific web component that is used in <code>ui5-shellbar</code>
 ...
 * <code>import "@kengine/webcomponents-fiori/dist/ProductSwitch.js";</code>
 * <br>
 * <code>import "@kengine/webcomponents-fiori/dist/ProductSwitchItem.js";</code> (for <code>ui5-product-switch-item</code>)
 * @constructor
...
class ProductSwitch extends KENGINEElement {
	constructor() {
		super();
	...
	static async onDefine() {
		ProductSwitch.i18nBundle = await getI18nBundle("@kengine/webcomponents-fiori");
	}
