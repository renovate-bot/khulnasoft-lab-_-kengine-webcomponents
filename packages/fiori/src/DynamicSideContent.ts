 ...
 *
 * <code>import "@kengine/webcomponents-fiori/dist/DynamicSideContent";</code>
 *
 * @constructor
...
class DynamicSideContent extends KENGINEElement {
	/**
	...
	static async onDefine() {
		DynamicSideContent.i18nBundle = await getI18nBundle("@kengine/webcomponents-fiori");
	}
