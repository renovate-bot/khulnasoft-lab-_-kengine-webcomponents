...
import { isSpace, isEnter, isSpaceShift } from "@kengine/webcomponents-base/dist/Keys.js";
 ...
 * <code>import "@kengine/webcomponents-fiori/dist/ProductSwitchItem.js";</code>
 *
 * @constructor
...
@event("click")
@event("_focused")
class ProductSwitchItem extends KENGINEElement implements ITabbable {
	constructor() {
		super();
	 ...
	 *
	 * See all the available icons in the <ui5-link target="_blank" href="https://sdk.kengine.org/test-resources/sap/m/demokit/iconExplorer/webapp/index.html">Icon Explorer</ui5-link>.
	 *
	 * @type {string}
